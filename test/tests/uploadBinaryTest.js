...
const createAndUpdateFileAndCheckContents = (originalContents, updatedContents) => createFileAndCheckContents(originalContents).then(createdFile => updateFileAndCheckContents(createdFile._id, updatedContents));
